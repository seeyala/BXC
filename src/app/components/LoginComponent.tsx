...
const LoginComponent: React.FC = () => {
  return (
      <div
    className="w-[1440px] h-[960px] relative overflow-hidden bg-black-25 border border-black shadow-custom-shadow"
    >
    ...
    <img
      src="login.png"
      className="w-[90px] h-[90px] absolute left-[1113px] top-[549px] object-contain"
    />
    <p className="w-[202px] h-12 absolute left-[75px] top-[19px] text-xl font-bold text-left text-black">
      Name company
    </p>
    <p className="w-[199px] h-6 absolute left-[953px] top-[503px] text-base font-bold text-left text-gray-custom">
      Forget Password
    </p>
  </div>
  );
